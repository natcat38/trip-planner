...
| `src/components` | 5 | Shared presentational components used across trip pages: currently the Mapbox pin map that plots an itinerary's geocoded activity places. |
...
25 source directories, 92 files, 0 without a declared purpose.
