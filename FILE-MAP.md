...
| `src/lib` | 13 | Byte-size formatting, shared by the attachment server module and its client component. |
...
25 source directories, 100 files, 0 without a declared purpose.
