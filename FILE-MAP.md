...
| `src/lib` | 12 | Byte-size formatting, shared by the attachment server module and its client component. |
...
25 source directories, 99 files, 0 without a declared purpose.
