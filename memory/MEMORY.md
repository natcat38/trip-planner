...
- [Attachment upload e2e flake](project_attachment_upload_e2e_flake.md) — CI-only stall of the upload tests (Node 20 and 24 alike): action ran, streamed response never finished; rerun before blaming a version bump.
